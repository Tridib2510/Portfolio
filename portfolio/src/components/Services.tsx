  ...
  return (
    ...
    <div className="grid grid-cols-auto gap-6 my-10">{/* Here me need 4 cols with a gap of 6 between them */}
      ...
      {serviceData.map(({icon,title,description,link},index)=>(
        <div key={index}
        className='border border-gray-400 rounded-lg px-8 py-12 shadow-black hover:shadow-black hover:shadow-lg cursor-pointer hover:bg-purple-100 hover:-translate-y-1 duration-500'
        >
